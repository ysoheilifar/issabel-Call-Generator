...
<center>
<input type="text" class="w3-input" placeholder="issabel IP Address" name="ippbx" style="width:30%">
<br></br>
<input type="text" class="w3-input" placeholder="AMI UserName" name="amiuser" style="width:30%">
<br></br>
<input type="text" class="w3-input" placeholder="AMI Secret" name="amisecret" style="width:30%">
<br></br>
...
$exten2 = $_POST['callee'];
$trunk = $_POST['trunk'];
$asterisk_ip = $_POST['ippbx'];
$username = $_POST['amiuser'];
$secret = $_POST['amisecret'];
$timeout = 5000;
